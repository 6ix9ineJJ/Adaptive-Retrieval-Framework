...
from rag_techniques.hypothetical_document_rag import HypotheticalDocumentRAG
from rag_techniques.self_reflection_rag import SelfReflectionRAG
...
class RAGPlayground:
    def __init__(self):
        ...
        self.techniques = {
            ...
            "HyDE (Hypothetical Doc Embedding)": HypotheticalDocumentRAG(),
            "Self-RAG": SelfReflectionRAG(),

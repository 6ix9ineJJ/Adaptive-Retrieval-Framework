...
| **HyDE (Hypothetical Document)** | Generate hypothetical answer → embed → retrieve | Zero-shot recall, quirky phrasing |
...
│ │ ├─ corrective_rag.py
│ │ ├─ fusion_rag.py
│ │ ├─ hypothetical_document_rag.py
│ │ ├─ self_reflection_rag.py
│ │ ├─ speculative_rag.py
│ │ └─ standard_rag.py
│ ├─ main_application.py        # Entry point: select strategy & Q&A loop
│ ├─ data_ingestion.py          # Build synthetic dataset & Chroma index
│ └─ configuration_loader.py     # Configuration management system
├─ configs/
